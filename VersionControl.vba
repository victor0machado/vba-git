  ...
  With ThisWorkbook.VBProject
    For i = 1 To .VBComponents.Count
      If .VBComponents(i).CodeModule.CountOfLines > 0 Then
        ...
        .VBComponents(i).Export "D:\Victor\Pessoal\IBMEC\VBA\web_scraper_bolsa\teste git\" & name & ".vba"
      End If
    Next i
  End With
End Sub
    ...
    For i = 1 To .VBComponents.Count
      ...
      If module_name <> "VersionControl" Then
        If Right(module_name, 6) = "Macros" Then
          ...
          .VBComponents.Import "D:\Victor\Pessoal\IBMEC\VBA\web_scraper_bolsa\teste git\" & module_name & ".vba"
        End If
      End If
    Next i
  End With
